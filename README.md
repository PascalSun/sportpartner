...
### Brief
  ...
  So people can just register on our website about what they want and what they can do, we will match them up as a list( also can be shown on the map) based on the information they provide.
...
And the order of the partners will be decided by difference degree, which combined by location distance, age distance, and skill distance:  __diff = skill+age/5+(location distance)x200__    
